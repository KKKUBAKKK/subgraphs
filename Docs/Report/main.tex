...
\subsubsection{Algorytm Fazy 1: Generowanie Podzbiorów}
...
\subsubsection*{Dowód Poprawności (Faza 1)}
...
\subsubsection*{Analiza Złożoności (Faza 1)}
...
\subsubsection{Algorytm Fazy 2: Iteracyjne Rozwiązywanie i Rozszerzanie}
...
\subsection{Końcowa Analiza Złożoności Całkowitej}
