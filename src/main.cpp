...
int main(int argc, char** argv) {
    if (argc < 2) {
        std::cerr << "Usage: " << argv[0] << " <input_graph_file> [num_subgraphs] [algorithm: exact|approx] [heuristic: degree|directed|directed_ignore|histogram|structure|greedy]" << std::endl;
        return 1;
    }
